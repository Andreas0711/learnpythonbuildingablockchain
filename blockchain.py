...
# Methods --------------------------------------------------------
    ...
    def get_open_transactions(self):
        ...
        # Nur Kopie wird zurückgegeben durch [:].
    ...
    def get_balance(self, sender=None):
        ...
        if sender is None:
            ...
            participant = sender
        # Es werden alle Werte 'amount' jedes blocks ausgegeben, bei welchem
        # der übergebene participant der sender war.
    ...
    def add_transaction(self, recipient, sender, signature,  amount=1.0,
        ...
        # Es kann sein, wenn eine Transaktion an eine andere Node gesendet
        # wird, und diese nicht korrekt initalisiert ist, dass er auch hier
        # return false zurückgibt. Fehler muss noch behoben werden!!!
        if self.public_key is None:
            return False

        transaction = Transaction(sender, recipient, signature, amount)
        # get_balance ist eine Funktion, ohne Klammern heißt sie wird als
        # Referenz übergeben, wo sie dann in verify_transaction aufgerufen
        # werden kann.
        if Verification.verify_transaction(transaction, self.get_balance):
            self.__open_transactions.append(transaction)
            self.save_data()
            # Hier folgt der Broadcast zu den anderen Nodes.
            # Soll nur durch die Node ausgelöst werden, welche
            # die Transaction erstellt.
            # Ansonsten würde es zu einem Endlosloop kommen,
            # da jede Node die Transaktion hinzufügen würde,
    ...
    def mine_block(self):
        ...
        # block wird noch als nicht geordnete Liste deklariert,
        # um sort_keys=True als Parameter zu json.dumps() zu demonstrieren.
        ...
        for incoming_tx in block['transactions']:
            for open_tx in stored_transactions:
                if (open_tx.sender == incoming_tx['sender'] and
                    ...
                    open_tx.amount == incoming_tx['amount'] and
